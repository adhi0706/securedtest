      ...
      <div className="sss-settings-connected-accounts">
        <div className="sss-settings-connected-accounts-box">
          <div className="sss-settings-connected-accounts-box-icon">
            <img
              layout="intrinsic"
              src="/assets/images/securedapp-logo-light.svg/connected-accounts-verified.svg"
              alt="verified"
            />
          </div>
        ...
        <div className="sss-settings-connected-accounts-socials">
          <AccountCard
            logo={
              "/assets/images/securedapp-logo-light.svg/connected-accounts-google.svg"
            }
            accountType={"Google"}
          ...
          <AccountCard
            logo={
              "/assets/images/securedapp-logo-light.svg/connected-accounts-slack.svg"
            }
            accountType={"Slack"}
          ...
          <AccountCard
            logo={
              "/assets/images/securedapp-logo-light.svg/connected-accounts-dropbox.svg"
            }
            accountType={"Dropbox"}
