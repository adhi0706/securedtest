        ...
        <div className="auth-screen-body">
          <AuthCard footer={true} isLogin={true}>
            ...
            {/* <AuthButton filled={false}>
              <div className="auth-screen-google">
                <img layout="intrinsic"   layout="intrinsic"   
                  src="/assets/images/securedapp-logo-light.svg/google-logo.svg"
                  alt="Google Logo"
                />
            ...
            <div className="auth-logos-cards">
              <AuthLogos imagePath="/assets/images/securedapp-logo-light.svg/google-logo.svg" />
              <AuthLogos imagePath="/assets/images/securedapp-logo-light.svg/metamask.svg" />
              <AuthLogos imagePath="/assets/images/securedapp-logo-light.svg/github-icon.svg" />
            </div>
          </AuthCard>
        </div>
      </div>
