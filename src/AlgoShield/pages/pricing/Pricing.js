                          ...
                          <div className="sss-pricing-plan-detail-row-value-container">
                            ...
                            >
                              {detail.details[feature].value === "TICK" ? (
                                <img
                                  layout="intrinsic"
                                  src="/assets/images/securedapp-logo-light.svg/billing-price-tick.svg"
                                  alt="tick"
                                />
                              ) : detail.details[feature].value === "DASH" ? (
                                <img
                                  layout="intrinsic"
                                  src="/assets/images/securedapp-logo-light.svg/billing-price-dash.svg"
                                  alt="-"
                                />
                              ) : (
                              ...
                              {detail.details[feature].info && (
                                <div className="sss-pricing-plan-detail-row-info-container group">
                                  <img
                                    layout="intrinsic"
                                    src="/assets/images/securedapp-logo-light.svg/pricing-plan-info.svg"
                                    alt="i"
                                  />
        ...
        <div className="sss-pricing-plan-footer-buttons">
          ...
          <div className="sas-pricing-plan-footer-button-container">
            <CustomButton
              ...
              onClick={() => navigate.push("/algoshield/contact")}
            />
          </div>
        </div>
      </div>
