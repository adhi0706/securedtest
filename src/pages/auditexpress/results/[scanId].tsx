...
import ScanPage from './Scanpage'; // Adjust the path to where your ScanPage component is located
...
const ScanResultPage = () => {
  ...
  const parsedVulnerabilityCount = vulnerabilityCount ? JSON.parse(vulnerabilityCount as string) : null;
