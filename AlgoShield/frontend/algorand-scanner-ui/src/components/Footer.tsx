    ...
    <footer className="bg-gray-900 text-white py-8 mt-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">AlgoShield</h3>
            <p className="text-gray-400 text-sm">
              Professional security analysis platform for Algorand smart contracts across multiple languages and frameworks.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; 2024 AlgoShield Security Platform. All rights reserved. Built for the Algorand ecosystem.</p>
        </div>
      </div>
    </footer>
  )
